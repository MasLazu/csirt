...
public class PagePermissionSeeder
{
    ...
    public async Task SeedAsync(CancellationToken ct = default)
    {
        var mappings = new (string PageCode, string PermissionCode)[]
        {
            ...
            // Threat events
            ("TE_LIST","READ:THREAT_EVENT"),
            // Threat intel
            ("TI_MALWARE_FAMILIES","READ:MALWARE_FAMILY"),
            // Network
            ("NET_PROTOCOLS","READ:PROTOCOL"),
            ("NET_ASN_REGISTRIES","READ:ASN_REGISTRY"),
            // Geography
            ("GEO_COUNTRIES","READ:COUNTRY"),
            // Tenant admin global perspective
            ("TEN_TENANTS","READ:TENANT"),
