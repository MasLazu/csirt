...
public class GetTenantRolesEndpoint : BaseTenantAuthorizedEndpoint<GetTenantRolesPaginatedQuery, IEnumerable<RoleDto>, GetTenantRolesEndpoint>, ITenantPermissionProvider, IPermissionProvider
{
