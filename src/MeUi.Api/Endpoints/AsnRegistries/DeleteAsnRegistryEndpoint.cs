...
public class DeleteAsnRegistryEndpoint : BaseAuthorizedEndpoint<DeleteAsnRegistryCommand, Guid, DeleteAsnRegistryEndpoint>, IPermissionProvider
{
    ...
    public override async Task HandleAuthorizedAsync(DeleteAsnRegistryCommand req, Guid userId, CancellationToken ct)
    {
