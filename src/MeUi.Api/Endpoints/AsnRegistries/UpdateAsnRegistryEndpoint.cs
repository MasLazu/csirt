...
public class UpdateAsnRegistryEndpoint : BaseEndpoint<UpdateAsnRegistryCommand, Guid>, IPermissionProvider
{
    ...
    public override async Task HandleAsync(UpdateAsnRegistryCommand req, CancellationToken ct)
    {
