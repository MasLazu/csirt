...
public class GetThreatIntelligenceQueryHandler : IRequestHandler<GetThreatIntelligenceQuery, ThreatIntelligenceListDto>
{
    ...
    public async Task<ThreatIntelligenceListDto> Handle(GetThreatIntelligenceQuery request, CancellationToken ct)
    {
        ...
        try
        {
            ...
            {
                var sourceAddress = request.SourceAddress;
                predicate = CombineExpressions(predicate, t => t.SourceAddress.ToString().Contains(sourceAddress));
            }
            ...
            Expression<Func<ThreatEvent, object>>? orderBy = request.SortBy?.ToLower() switch
            {
                ...
                "sourceaddress" => t => t.SourceAddress.ToString(),
            ...
            var dtoItems = itemsWithIncludes.Select(t => new ThreatIntelligenceItemDto
            {
                Id = t.Id,
                Timestamp = t.Timestamp,
                SourceAddress = t.SourceAddress.ToString(),
                DestinationAddress = t.DestinationAddress?.ToString(),
                Asn = t.AsnRegistry.Asn,
                AsnDescription = t.AsnRegistry.Description,
                SourceCountry = t.SourceCountry?.Code,
                DestinationCountry = t.DestinationCountry?.Code,
                Category = t.Category,
            ...
            return new ThreatIntelligenceListDto
            {
                Items = dtoItems,
