...
public class GetThreatIntelligencePaginatedQueryValidator : AbstractValidator<GetThreatIntelligencePaginatedQuery>
{
    ...
    public GetThreatIntelligencePaginatedQueryValidator()
    {
