...
public class ThreatIntelligenceFilterValidator : AbstractValidator<ThreatIntelligenceFilter>
{
    private static readonly string[] ValidSortFields =
    {
        "timestamp", "asn", "category", "sourceaddress", "sourcecountry",
        "destinationaddress", "destinationcountry", "protocol", "malwarefamily"
    };

    public ThreatIntelligenceFilterValidator()
    {
