...
public class TokenRefreshCommandHandler : IRequestHandler<TokenRefreshCommand, TokenRefreshResponse>
{
    ...
    public async Task<TokenRefreshResponse> Handle(TokenRefreshCommand request, CancellationToken ct)
    {
