...
public class GetThreatEventsPaginatedQueryValidator : AbstractValidator<GetThreatEventsPaginatedQuery>
{
    public GetThreatEventsPaginatedQueryValidator()
    {
        RuleFor(x => x.Page)
            .GreaterThan(0)
    ...
    private static bool ValidateTimeRange(GetThreatEventsPaginatedQuery query)
    {
