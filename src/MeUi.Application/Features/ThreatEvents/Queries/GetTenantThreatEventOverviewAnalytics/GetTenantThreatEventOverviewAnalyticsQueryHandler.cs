...
public class GetTenantThreatEventOverviewAnalyticsQueryHandler : IRequestHandler<GetTenantThreatEventOverviewAnalyticsQuery, ThreatEventOverviewAnalyticsDto>
{
    private readonly IThreatEventAnalyticsRepository _analyticsRepository;

    public GetTenantThreatEventOverviewAnalyticsQueryHandler(IThreatEventAnalyticsRepository analyticsRepository)
    {
        _analyticsRepository = analyticsRepository;
    }

    public async Task<ThreatEventOverviewAnalyticsDto> Handle(GetTenantThreatEventOverviewAnalyticsQuery request, CancellationToken ct)
    {
